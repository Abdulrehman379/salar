...
export default function HomePage() {
            ...
            <div>
              ...
              <div className="space-y-3">
                <p className="flex items-center gap-3">
                  ...
                  <span className="text-muted-foreground">abdulrehmanbhatti976@gmail.com</span>
                </p>
                <p className="flex items-center gap-3">
                  <span className="font-semibold">Phone:</span>
                  <span className="text-muted-foreground">(092) 345-8229007</span>
                </p>
                <p className="flex items-center gap-3">
                  <span className="font-semibold">Address:</span>
                  <span className="text-muted-foreground">Street Abdullah Moh Ahmad Abad,lalian</span>
                </p>
              </div>
            </div>
            <form
  ...
  Demonstrating that great websites don&apos;t need complex frameworks
</p>
